...
(function () {
  const translations = {
    ua: {
      ...
      slider_signature: "Авторські страви від шефа",
      slider_breakfast: "Салат з тигровими креветками",
      slider_interior: "Особуко на шафрановому різото",
      slider_bar: "Авторські коктейлі та напої",
      pill_signature: "Страви від шефа",
    ...
    en: {
      ...
      slider_signature: "Chef's Signature Dishes",
      slider_breakfast: "Tiger Prawn & Avocado Salad",
      slider_interior: "Braised Ossobuco with Risotto",
      slider_bar: "Signature Cocktails & Refreshments",
      pill_signature: "Chef's Dishes",
    ...
    ru: {
      ...
      slider_signature: "Авторские блюда от шефа",
      slider_breakfast: "Салат с тигровыми креветками",
      slider_interior: "Оссобуко на шафрановом ризотто",
      slider_bar: "Авторские коктейли и напитки",
      pill_signature: "Блюда от шефа",
