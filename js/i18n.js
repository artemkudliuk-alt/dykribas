...
(function () {
  const translations = {
    ua: {
      ...
      screen_4: "04. Банкет-хол",
      screen_5: "05. Балкон & Одеса",
      ...
      mob_screen_4: "Конференц-зал",
      mob_screen_5: "Балкон & Одеса",
      ...
      screen2_roomservice_time: "08:00–23:00",
      ...
      slider_signature: "Качине філе на ніжному пюре",
      slider_breakfast: "Салат із тигровими креветками",
      slider_interior: "Особуко на шафрановому різото",
      slider_bar: "Освіжаючий цитрусовий коктейль",
      pill_signature: "Качине філе",
      pill_breakfast: "Салати",
      pill_interior: "Особуко",
      pill_bar: "Коктейлі",
      ...
      screen3_massage_desc: "Індивідуальні години за попереднім записом на рецепції (101)",
      screen3_btn_menu: "Переглянути SPA-меню та вартість процедур",
      screen3_btn_book: "Записатися на СПА (101)",
      ...
      screen4_desc: "Готель Ribas Duke запрошує провести ваші найважливіші події на найвищому рівні. До ваших послуг — вишуканий банкетний зал для масштабних конференцій та сучасні кімнати для переговорів, оснащені преміальним мультимедійним обладнанням. Створюйте бездоганне враження під час презентацій, ділових зустрічей чи закритих урочистостей у самому серці Одеси.",
      ...
      screen4_conf_desc: "Гнучка розсадка (до 50–80 осіб), професійний звук та проекційне обладнання",
      ...
      screen6_btn_reception: "Зв’язатися з рецепцією (101)",
      ...
      pillow_modal_desc: "Ідеальний сон — мистецтво відпочинку. Оберіть подушку та замовте на рецепції (101).",
      pillow_order_btn: "ЗАМОВИТИ В НОМЕР (101)",
      ...
      spa_modal_card4_title: "Лаунж-зона та фіто-бар",
      spa_modal_card4_desc: "Завершити процедури можна у зоні відпочинку за чашкою ароматної свіжої кави або добірного трав'яного чаю.",
      spa_modal_guest_badge: "ТАРИФИ ТА ГОСТЬОВІ ВІЗИТИ",
      spa_modal_guest_heading: "Для відвідувачів без проживання в готелі",
      spa_modal_guest_sub: "Якщо ви не є гостем готелю Ribas Duke, ви також можете придбати індивідуальне або повне відвідування:",
      spa_modal_plan1_title: "Гостьовий візит у басейн",
      spa_modal_plan1_f1: "Користування басейном (35 м²)",
      spa_modal_plan1_f2: "Зона шезлонгів та рушники",
      spa_modal_plan2_title: "Повний гостьовий візит",
      spa_modal_plan2_f1: "Користування басейном",
      spa_modal_plan2_f2: "Кардіо-зал",
      spa_modal_plan2_f3: "Банні процедури (хамам і сауна до 2 годин)",
      spa_modal_price_hour: "700 грн / год",
      spa_modal_note: "Мінімальна тривалість гостьового візиту — 2 години. Бронювання здійснюється на рецепції готелю.",
      spa_modal_btn_book: "Забронювати на рецепції (101)",
    ...
    en: {
      ...
      screen_4: "04. Banquet Hall",
      screen_5: "05. Balcony & Odesa",
      ...
      mob_screen_4: "Conference Hall",
      mob_screen_5: "Balcony & Odesa",
      ...
      slider_signature: "Duck Fillet on Creamy Purée",
      slider_breakfast: "Tiger Prawn & Avocado Salad",
      slider_interior: "Ossobuco with Saffron Risotto",
      slider_bar: "Refreshing Citrus Cocktail",
      pill_signature: "Duck Fillet",
      pill_breakfast: "Salads",
      pill_interior: "Ossobuco",
      pill_bar: "Cocktails",
      ...
      screen3_massage_desc: "Private sessions by appointment at front desk (101)",
      screen3_btn_menu: "View SPA Menu & Treatment Prices",
      screen3_btn_book: "Book SPA & Massage (101)",
      
      // Screen 4: Conference & Events
      screen4_tagline: "CONFERENCE & EVENTS",
      screen4_title: "SPACE FOR SUCCESSFUL EVENTS<br>& BUSINESS MEETINGS",
      screen4_desc: "Ribas Duke Boutique Hotel invites you to host your most important events at the highest level. At your service: an exquisite banquet hall for conferences and modern meeting rooms with premium multimedia equipment. Create an unforgettable impression in the heart of Odesa.",
      ...
      screen4_conf_desc: "Flexible seating (up to 50–80 guests), professional acoustics & projection systems",
      ...
      screen5_btn_map: "Tourist Route Map",
      ...
      screen6_btn_reception: "Call Reception (101)",
      ...
      pillow_modal_desc: "Perfect sleep is the art of relaxation. Choose your pillow and order at reception (101).",
      pillow_order_btn: "ORDER TO ROOM (101)",
      ...
      spa_modal_card4_title: "Lounge Area & Herbal Tea Bar",
      spa_modal_card4_desc: "Complete your wellness rituals in our serene lounge with a freshly brewed cup of aromatic coffee or curated organic herbal tea.",
      spa_modal_guest_badge: "RATES & GUEST PASSES",
      spa_modal_guest_heading: "For Non-Resident Visitors",
      spa_modal_guest_sub: "If you are not staying at Ribas Duke, you can still reserve access for a personal or complete wellness pass:",
      spa_modal_plan1_title: "Pool Guest Pass",
      spa_modal_plan1_f1: "Indoor pool access (35 m²)",
      spa_modal_plan1_f2: "Lounge beds and towels provided",
      spa_modal_plan2_title: "Full Day-Spa Guest Pass",
      spa_modal_plan2_f1: "Indoor pool access",
      spa_modal_plan2_f2: "Cardio gym access",
      spa_modal_plan2_f3: "Thermal bath rituals (hammam & sauna up to 2 hours)",
      spa_modal_price_hour: "700 UAH / hr",
      spa_modal_note: "Minimum duration for guest visits is 2 hours. Reservations available at front desk reception.",
      spa_modal_btn_book: "Reserve at Front Desk (101)",
    ...
    ru: {
      ...
      slider_signature: "Утиное филе на нежном пюре",
      slider_breakfast: "Салат с тигровыми креветками",
      slider_interior: "Оссобуко на шафрановом ризотто",
      slider_bar: "Освежающий цитрусовый коктейль",
      pill_signature: "Утиное филе",
      pill_breakfast: "Салаты",
      pill_interior: "Оссобуко",
      pill_bar: "Коктейли",
      ...
      screen4_conf_desc: "Гибкая рассадка (до 50–80 человек), профессиональный звук и проекционное оборудование",
      ...
      screen6_btn_reception: "Связаться с рецепцией (101)",
      ...
      pillow_modal_desc: "Идеальный сон — искусство отдыха. Выберите подушку и закажите на рецепции (101).",
      pillow_order_btn: "ЗАКАЗАТЬ В НОМЕР (101)",
      ...
      spa_modal_card4_title: "Лаунж-зона и фито-бар",
      spa_modal_card4_desc: "Завершить процедуры можно в зоне отдыха за чашкой ароматного кофе или отборного травяного чая.",
      spa_modal_guest_badge: "ТАРИФЫ И ГОСТЕВЫЕ ВИЗИТЫ",
      spa_modal_guest_heading: "Для гостей без проживания в отеле",
      spa_modal_guest_sub: "Если вы не проживаете в отеле Ribas Duke, вы также можете забронировать индивидуальное или полное посещение:",
      spa_modal_plan1_title: "Гостевой визит в бассейн",
      spa_modal_plan1_f1: "Посещение бассейна (35 м²)",
      spa_modal_plan1_f2: "Зона шезлонгов и полотенца",
      spa_modal_plan2_title: "Полный гостевой визит",
      spa_modal_plan2_f1: "Посещение бассейна",
      spa_modal_plan2_f2: "Кардио-зал",
      spa_modal_plan2_f3: "Банные процедуры (хаммам и сауна до 2 часов)",
      spa_modal_price_hour: "700 грн / час",
      spa_modal_note: "Минимальная продолжительность гостевого визита — 2 часа. Бронирование осуществляется на рецепции отеля.",
      spa_modal_btn_book: "Забронировать на рецепции (101)",
