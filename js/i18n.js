...
(function () {
  const translations = {
    ua: {
      ...
      slider_signature: "Авторські страви",
      slider_breakfast: "Сніданки",
      slider_interior: "Інтер’єр ресторану",
      slider_bar: "Лобі-бар",
      pill_signature: "Страви",
      pill_breakfast: "Сніданки",
      pill_interior: "Інтер'єр",
      pill_bar: "Бар",
    ...
    en: {
      ...
      slider_signature: "Signature Dishes",
      slider_breakfast: "Breakfasts",
      slider_interior: "Restaurant Interior",
      slider_bar: "Lobby Bar",
      pill_signature: "Dishes",
      pill_breakfast: "Breakfast",
      pill_interior: "Interior",
      pill_bar: "Bar",
    ...
    ru: {
      ...
      slider_signature: "Авторские блюда",
      slider_breakfast: "Завтраки",
      slider_interior: "Интерьер ресторана",
      slider_bar: "Лобби-бар",
      pill_signature: "Блюда",
      pill_breakfast: "Завтраки",
      pill_interior: "Интерьер",
      pill_bar: "Бар",
