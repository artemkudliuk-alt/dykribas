...
(function () {
  ...
  const PDF_PAGE_MAP = {
    ...
    'duke_conference_opportunities': Array.from({length: 19}, (_, i) => `docs/conference_page_${i + 1}.webp`),
    'conference': Array.from({length: 19}, (_, i) => `docs/conference_page_${i + 1}.webp`),
    'Ribas Duke Conference': Array.from({length: 19}, (_, i) => `docs/conference_page_${i + 1}.webp`)
  };
  ...
  window.openConferencePdfModal = function () {
    ...
    `;
    window.openDukePdfModal(
      t('screen4_btn_pdf') || "Конференц-можливості — Ribas Duke",
      "Презентація залів, схем розсадки, обладнання та сервісу:",
      'docs/duke_conference_opportunities.pdf',
      cta
    );
  };
